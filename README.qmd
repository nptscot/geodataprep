...
```{r}
simplified_roads = sf::st_read("../npt/inputdata/open_roads_scotland.geojson") |> sf::st_transform(crs = 27700)
```

# Scotland region and local authority boundaries
```{r}
lads = sf::st_read("data/la_regions_scotland_bfe_simplified_2023.geojson")  |> sf::st_transform(crs = 27700)
...
sf::st_write(mm_data_scot, "data/mm_data_RoadLink_Scotland.geojson")
```
...
mm_data_zone = mm_data[sf::st_union(zone), , op = sf::st_intersects]
