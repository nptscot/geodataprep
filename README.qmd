...
```{r}
rnet_x = sf::read_sf("data_raw/one_line.geojson")
rnet_y = sf::read_sf("data_raw/two_lines.geojson")
...
rnet_x = sf::read_sf("data_raw/simplified_network.geojson") |> 
  sf::st_transform(27700)
rnet_y = sf::read_sf("data_raw/mm_data_RoadLink_Scotland.gpkg") |> 
  sf::st_transform(27700)
